...
from policies.nn.absolute.features import NNAbsoluteFeatures, NNAbsoluteFeaturizer, CurtainInfo
import utils

REGISTERED_NETWORK_CLASSES = {}

ingr = utils.Ingredient("nn_absolute")
...
class NNAbsoluteActor(Actor):
    ...
    def __init__(self,
        ...
        self.history: List[NNAbsoluteActor.PrevOC] = []
    ...
    def step(self,
        ...
        oc = NNAbsoluteActor.PrevOC(obs, cinfo)
    ...
    def forward(self,
                feats: Union[np.ndarray, NNAbsoluteFeatures]) -> td.Distribution:
        """
        Args:
            feats (Union[np.ndarray, NNAbsoluteFeatures])): features.
...
class CNN(nn.Module):
    ...
    def forward(self,
                feat: NNAbsoluteFeatures) -> td.Distribution:
        """
        Args:
